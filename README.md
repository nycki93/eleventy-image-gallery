...
Right-click inside that folder to open a terminal, and type `npm install`. This should download some stuff into a folder called 'node_modules'. You can go offline now, that's all we need. If you ever want to uninstall, just delete 'node_modules'.
